            ...
            <nav className='navbar flex flex-col justify-around items-center w-full h-auto border-b-2 border-black'>
                ...
                <div className="flex flex-row items-center w-full justify-between px-4 py-2">
                    ...
                    <div id="opened-icon" className="flex">
                        <ListIcon id="navbar-toggle" onClick={openNavbar} className='z-10 cursor-pointer hover:text-black' size={25} />
                    </div>
                </div>
                ...
                <div className='routes flex justify-center flex-col gap-4 text-lg fixed right-0 top-0 h-full w-1/2 bg-[var(--fg)] text-white px-4 py-2 hidden'>
